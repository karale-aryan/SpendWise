...
const Login = () => {
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 p-4 transition-colors duration-300 dark:bg-slate-950">
            <div className="pointer-events-none absolute -top-20 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-emerald-200/50 blur-3xl dark:bg-emerald-500/30" />
            <div className="pointer-events-none absolute bottom-0 right-0 h-64 w-64 rounded-full bg-cyan-100 blur-3xl dark:bg-cyan-500/20" />
            <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl shadow-slate-200/50 backdrop-blur-xl transition-colors duration-300 dark:border-slate-700/60 dark:bg-slate-900/90 dark:shadow-none">
                <div className="text-center mb-8">
                    <div className="w-12 h-12 bg-emerald-500/15 text-emerald-500 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <Lock size={24} />
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Welcome Back</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-2">Sign in to your AI-powered finance workspace</p>
                </div>
